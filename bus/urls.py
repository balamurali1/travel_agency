...
from bus.views import home,bus_create,bus_update,bus_delete,home1,car_create,car_update,car_delete,home2,passenger_create,passenger_update,passenger_delete,home3,trip_create,trip_update,trip_delete
